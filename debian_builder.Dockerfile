...
ARG cmake_latest_tag_name=v3.21.2
...
ARG meson_latest_tag_name=0.59.1
...
ARG image_build_date=2021-09-04
...
ARG openssl_latest_commit_hash=09126044f0120b0039b13365b30465d4b6d0f8f0
## curl -sSL 'https://raw.githubusercontent.com/openssl/openssl/OpenSSL_1_1_1-stable/README' | grep -Eo '1.1.1.*'
ARG openssl_latest_tag_name=1.1.1m-dev
WORKDIR /build_root
RUN source '/root/.bashrc' \
