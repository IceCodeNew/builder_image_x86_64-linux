...
ARG checksec_latest_tag_name=3.0.2
...
ARG cmake_latest_tag_name=v3.31.6
...
ARG image_build_date=2025-03-17
...
ARG mold_latest_tag_name=v2.37.1
...
ARG zlib_ng_latest_tag_name=2.2.4
WORKDIR /build_root
RUN source '/root/.bashrc' \
